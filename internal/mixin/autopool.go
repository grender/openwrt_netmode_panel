...
// выбрал домашний узел, уведя туда трафик, который гнали в туннель
// ради обхода (docs/recon/raw/95-autopool-spike.txt).
//
...
// «🇨🇻⚪Чарли (РЦ-1)☁️» без экранирования стала бы группой захвата.
// Якоря обязательны по другой причине: mihomo применяет фильтр как
// «содержит», и без них «Альфа» совпала бы и с «Альфа-2», а «Гольф-1»
// поймала бы «Гольф-10».
