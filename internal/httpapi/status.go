...
// Links — адреса веб-морд движков для браузера владельца.
//
...
//
// null означает «адрес не собран» — либо Host непригоден (петля, мусор),
// либо ссылка ещё не реализована (nikki). Панель обязана прятать кнопку,
// а не подставлять свой адрес наугад.
type Links struct {
